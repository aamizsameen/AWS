...
## Helm
[Helm](https://github.com/aamizsameen/AWS/tree/main/Helm) A package manager for Kubernetes. Discover Helm charts and commands to simplify Kubernetes application deployment and management.

## Jenkins
[Jenkins](https://github.com/aamizsameen/AWS/tree/main/Jenkins) An open-source automation server. This section includes Jenkins pipelines and job configurations to automate various tasks and workflows.
...
## Shell
[Shell Scripts](https://github.com/aamizsameen/AWS/tree/main/Shell) Very useful for automating tasks. This section contains various scripts for managing AWS resources and performing routine tasks.
